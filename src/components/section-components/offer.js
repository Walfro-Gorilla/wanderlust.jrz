			    ...
			    <div className="row justify-content-center">
			      <div className="col-xl-6 col-lg-8">
			        <div className="section-title text-center">
			          <h2 className="title">Promociones Especiales &amp; Descuentos</h2>
			          <p>Tenemos las mejores promociones y precios en todo Mexico, seguro encontraras algo a tu medida...</p>
			        </div>
			      </div>
			    </div>
			  </div>
			          ...
			          <div className="destinations-list-slider">
			            <div className="d-list-slider-item">
			              <div className="single-destinations-list text-center">
			                <div className="thumb">
			                  <span className="d-list-tag">Promo Oferta</span>
			                  ...
			                  <div className="d-list-btn-wrap">
			                    <div className="d-list-btn viaje-go-top">
			                      <Link className="btn btn-yellow" to="/contact">Reservar<i className="fa fa-paper-plane" /></Link>
			                    </div>
			                  </div>
			                </div>
			                <div className="details">
			                  <h4 className="title">Tour Reconecta Sep</h4>
			                  <p className="content">Enamorate de la majestuosa cascada de Basaseachi, del magico pueblo de Creel, y de las inmensas Barrancas del cobre</p>
			                  <ul className="tp-list-meta border-bt-dot">
			                    <li><i className="fa fa-calendar-o" /> 16sep</li>
			                  ...
			                  <div className="tp-price-meta tp-price-meta-cl">
			                    ...
			                    <h2>1,700 <small>$</small></h2>
			                    <del>2,200<span>$</span></del>
			                  </div>
			                </div>
			              </div>
			            </div>
